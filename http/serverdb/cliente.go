...
func UsuarioHandler(w http.ResponseWriter, r *http.Request) {
	// Obter o ID, a partir da URL
	// nesse caso, vai retirar tudo da URL até onde estiver
	// /usuarios/. Dessa forma vai pegar apenas o ID.
	...
	default:
		...
		fmt.Fprintf(w, "Página não encontrada...Sorry! :(")
	}
}
